...
MODEL_DIR="results/SingleCombat/1v1/NoWeapon/Selfplay/ppo/v1_selfplay_from_baseline/run3"
...
# We set num_env_steps to a low value to ensure it only runs for roughly one episode.
